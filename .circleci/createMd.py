...
| | <details><summary>schemas from Marketing/Sales</summary>${MarketingSales}<br></details> | |
...
| | <details><summary>schemas from Customer</summary>${Customer}<br></details> | |
...
| | <details><summary>schemas from Service</summary>${Service}<br></details> | |
...
| | <details><summary>schemas from Resource</summary>${Resource}<br></details> | |
...
| | <details><summary>schemas from Engaged Party</summary>${EngagedParty}<br></details> | |
